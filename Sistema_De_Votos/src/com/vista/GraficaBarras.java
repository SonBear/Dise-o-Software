...
public class GraficaBarras extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Canditado 1: " + votos_1, 10, 30);
        g.fillRect(40, 40, largo_voto_1, 30);
        g.setColor(new Color(0, 240, 0));
        g.drawString("Canditado 2: " + votos_2, 10, 85);
        g.fillRect(40, 90, largo_voto_2, 30);
        g.setColor(new Color(0, 0, 240));
        g.drawString("Canditado 3: " + votos_3, 10, 135);
        g.fillRect(40, 140, largo_voto_3, 30);
